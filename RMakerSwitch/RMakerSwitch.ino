...
int autoOffTimerDelay = 100; //60000 60sec
int autoOffTimerStart = 0;
...
//        (switch_state == false) ? digitalWrite(gpio_switch, HIGH) : digitalWrite(gpio_switch, LOW);
...
void loop()
{
    ...
    if(digitalRead(gpio_0) == LOW) { //Push button pressed
     ...
     if (switch_state && (autoOffTimerEnd - autoOffTimerStart) > autoOffTimerDelay) {
          switch_state = !switch_state;
          Serial.printf("Auto Stopped!!\n");
          digitalWrite(gpio_switch, HIGH);
